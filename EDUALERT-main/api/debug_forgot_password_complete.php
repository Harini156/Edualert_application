...
if ($conn) {
    try {
        $test_email = 'rajanharini1@gmail.com'; // Use the email from your test
...
if ($conn) {
    try {
        $test_email = 'rajanharini1@gmail.com';
            ...
            <div class="test-form">
                ...
                <form action="send_otp.php" method="POST" target="_blank">
                    <p>
                        ...
                        <input type="email" name="email" value="rajanharini1@gmail.com" style="width:300px; padding:8px;">
                    </p>
                    <p>
